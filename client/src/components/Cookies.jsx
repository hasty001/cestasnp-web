...
const Cookies = () => {
  return (
    <div id="Cookies">
        ...
        <br/>
        <p><b>Ako používame súbory cookie?</b></p>
        ...
        <br/>
        <p><b>Ako kontrolovať súbory cookie</b></p>
        ...
        <br/>
        <p><b>Ako odmietnuť používanie súborov cookie</b></p>
